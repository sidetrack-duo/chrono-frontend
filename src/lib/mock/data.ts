...
export const mockCommits: Commit[] = [
  {
    sha: "a1b2c3d4e5f6",
    message: "feat: 프로젝트 생성 페이지 UI 개선",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(0, 2),
  },
  {
    sha: "b2c3d4e5f6a7",
    message: "fix: 기술 스택 입력 시 자동완성 기능 수정",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(0, 5),
  },
  {
    sha: "c3d4e5f6a7b8",
    message: "refactor: API 클라이언트 에러 처리 로직 개선",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(0, 8),
  },
  {
    sha: "d4e5f6a7b8c9",
    message: "feat: 커밋 통계 차트 컴포넌트 추가",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(1, 2),
  },
  {
    sha: "e5f6a7b8c9d0",
    message: "docs: README 파일 업데이트",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(1, 6),
  },
  {
    sha: "f6a7b8c9d0e1",
    message: "style: 프로젝트 목록 카드 스타일 조정",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(1, 10),
  },
  {
    sha: "a7b8c9d0e1f2",
    message: "feat: 대시보드 위젯 추가",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(2, 3),
  },
  {
    sha: "b8c9d0e1f2a3",
    message: "fix: 인증 토큰 갱신 로직 수정",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(2, 7),
  },
  {
    sha: "c9d0e1f2a3b4",
    message: "test: 프로젝트 생성 API 테스트 추가",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(2, 12),
  },
  {
    sha: "d0e1f2a3b4c5",
    message: "chore: 의존성 패키지 업데이트",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(3, 1),
  },
  {
    sha: "e1f2a3b4c5d6",
    message: "feat: 프로젝트 상태 필터링 기능 구현",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(3, 5),
  },
  {
    sha: "f2a3b4c5d6e7",
    message: "refactor: 상태 관리 로직 최적화",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(3, 9),
  },
  {
    sha: "a3b4c5d6e7f8",
    message: "fix: 날짜 포맷팅 유틸리티 함수 수정",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(4, 2),
  },
  {
    sha: "b4c5d6e7f8a9",
    message: "feat: 커밋 히스토리 차트 컴포넌트 추가",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(4, 6),
  },
  {
    sha: "c5d6e7f8a9b0",
    ...
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(4, 11),
  },
  {
    sha: "d6e7f8a9b0c1",
    message: "style: 반응형 디자인 개선",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(5, 3),
  },
  {
    sha: "e7f8a9b0c1d2",
    message: "feat: 프로젝트 검색 기능 추가",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(5, 8),
  },
  {
    sha: "f8a9b0c1d2e3",
    message: "fix: GitHub API 호출 시 에러 처리 개선",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(5, 13),
  },
  {
    sha: "a9b0c1d2e3f4",
    message: "refactor: 컴포넌트 구조 개선",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(6, 1),
  },
  {
    sha: "b0c1d2e3f4a5",
    message: "chore: 빌드 설정 최적화",
    authorName: "testuser",
    authorEmail: "testuser@example.com",
    commitDate: getDateTimeString(6, 6),
  },
];
